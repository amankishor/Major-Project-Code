    ...
    <section>
        <div className='container'>
            <div className='flex justify-between gap-[50px] lg:gap-[130px] xl:gap-0 flex-col lg:flex-row'>
              ...
              md:leading-[] marginright'> proud to be on the nation best </h1>
                    ...
                    <p className='text__para mt-[30px]'>
                        ...
                        we can do tomorrow . providing the best . lorem ispum dolor sit amet ,consectur adipiscing elit. Aliquid, modi?
                    </p>
                    <Link to ="/">
